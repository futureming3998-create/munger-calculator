...
with st.sidebar:
    ...
    # 替换为您自己的打赏链接，此处使用示例按钮
    st.markdown(
        f'<a href="https://www.buymeacoffee.com/vcalculator" target="_blank" class="coffee-btn">'
        f'<img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png"></a>', 
        unsafe_allow_html=True
    )
